...
namespace robot{
    class CustomArm{
        ...
        protected:
            // Based the file to a real arm
            static constexpr double l1 = 0.5;
            static constexpr double l2 = 0.5;
            static constexpr double l3 = 0.5;
            static constexpr double l4 = 0.5;
            static constexpr double l5 = 0.5;
            static constexpr double l6 = 0.5;
            static constexpr double l7 = 0.5;
    }
}