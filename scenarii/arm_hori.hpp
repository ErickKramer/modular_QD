...
// Definition of the robotic arm
namespace robot{
    class Arm{
        public:
            static Eigen::Vector3d forward_model(Eigen::VectorXd a);
            static double max_length(){
                return p1_height+p2_height+p3_height+p4_height+p5_height+p6_height+p7_height+p8_height;
            }
    
        protected:
            // TODO: What are the units of the length of links?
